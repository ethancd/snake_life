...
(function() {
  window.Program = (function() {
    var $find, Game, Life, Snake, bindKeys, bindMouse, getName, modifyStyle, playSong, populateBoard, resetInfo, setLayout, setQuality, start;
    ...
    Game = (function() {
      ...
      Game.prototype.gameOver = function() {
        ...
        rawTime = Math.floor((new Date().getTime() - this.startTime.getTime()) / 1000);
      ...
      Game.prototype.postHighScore = function() {
        ...
        if (window.snakeUserName != null) {
          ...
          return userScoreRef.setWithPriority({
