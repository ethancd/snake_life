...
(function() {
  ...
  window.Program = (function() {
    var $find, Game, Life, Snake, bindKeys, bindMouse, modifyStyle, playSong, populateBoard, resetInfo, setLayout, setQuality, start;
    ...
    Snake = (function() {
      ...
      Snake.prototype.findNext = function() {
        var next, value;
        next = [this.body[0][0] + this.nextDir[0], this.body[0][1] + this.nextDir[1]];
        if (this.game.offscreen(next)) {
          next = (function() {
            var _i, _len, _results;
            _results = [];
            for (_i = 0, _len = next.length; _i < _len; _i++) {
              value = next[_i];
              _results.push(this.wrap(value));
            }
            return _results;
          }).call(this);
        }
      ...
      Snake.prototype.wrap = function(value) {
        if (value < 0) {
          return this.game.yDim - 1;
        } else if (value >= this.game.yDim) {
          return 0;
        } else {
          return value;
        }
      ...
      Snake.prototype.update = function() {
        ...
        if ((this.game.apple != null) && next.join() === this.game.apple.join()) {
          ...
          this.game.addApple();
        } else if (this.has(next) || this.game.life.has(next)) {
          this.game.gameOver();
        } else {
