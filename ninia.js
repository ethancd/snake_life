...
(function() {
  window.Program = (function() {
    var $find, Game, Life, Snake, bindCheckboxes, bindKeys, bindMouse, populateBoard, resetInfo, runIntro, showGameOverScreen, showInstructions, spanify, start;
    start = function() {
    ...
    bindCheckboxes = function(game) {
      $('#motion').change(game.toggleMotion.bind(game));
      return $('#guide').change(game.toggleGuide.bind(game));
    };
    $find = function(coord) {
    ...
    Game = (function() {
      function Game(size) {
        ...
        this.recentGuiding = this.guide = $('#guide').prop('checked');
        this.inMotion = $('#motion').prop('checked');
        this.recentStopping = !this.inMotion;
      ...
      Game.prototype.toggleMotion = function() {
        ...
        $('#motion').prop('checked', this.inMotion);
        if (this.inMotion) {
          title = "Snake on Fire!";
